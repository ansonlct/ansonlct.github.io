...
// ----------------------------------------------------------------
    ...
    function initCubeInteraction() {
        ...
        // ⚡️ 修正 1: 將容器改為 cube 實際所在位置 #about-section
        ...
        function autoRotateLoop(timestamp) {
            // 只有在沒有互動、沒有拖動、且沒有觸控時才自動轉
            if (!isInteracting && !isDragging && !isTouching) { 
        ...
        // 2.2. 觸摸移動 (Touch Move) - 監聽範圍擴大到 container
